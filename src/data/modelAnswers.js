export const modelAnswers = {
  ...
  "optimizing-linkedin-for-support":
    "Headline: Product Experience Analyst | Customer Success & SaaS Support | Technical Troubleshooting | Builder of BRIDGE CST, a Practical Support Learning Platform\n\nAbout: I help customers turn product problems into clear next steps through calm communication, structured troubleshooting, and cross-team ownership. At US Mobile, I support activations, technical cases, onboarding, and product questions across chat, email, and voice. I also built BRIDGE CST, a React-based customer support training platform with 64 practical Journey Cards for early-career professionals pursuing global careers. I am currently deepening my skills in APIs, support operations, AI workflows, and customer-success strategy.",
